            ...
            <div class="medium-8 medium-centered large-4 large-centered columns">
				...
				<table>
					...
					<tr>
						...
						<td><input type="radio" name="tdni" value="0" checked> L.E. <input type="radio" name="tdni" value="1"> D.N.I. <input type="radio" name="tdni" value="2"> L.C. <td>
					</tr>
					<tr>
					    <td><label>Nro Documento</label></td>
						<td><input type="number" required name="dni" id="dni" class="obligatorio" value=""/></td>
					</tr>
					<tr>
					    <td> <div id="resultado" align="center" /></div></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="date" name="fec_nac" value=""/></td>
					</tr>
			
					<tr>
					    <td><label>Habilitado<label></td>
						<td><input type="checkbox" name="habilitado" value=""/></td>
					</tr>
